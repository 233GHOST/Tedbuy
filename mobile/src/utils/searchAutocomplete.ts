 ...
 *
 * Ported verbatim from the web app's src/utils/searchAutocomplete.ts — mobile is
 * a standalone Expo project (no shared workspace with the web src/ tree), so this
 * pure, dependency-free logic is duplicated here rather than imported cross-project.
 */
