...
- `reviews` bulk read (`AppContext.tsx` ~2465) → migrate to the existing `GET /api/reviews`. Not started — low urgency, no PII in this table's schema, already flagged as P2/hygiene in §1.5.
