          ...
          >
            {(mediaGallery[activeMediaIdx]?.type === 'video' && !videoErrors[mediaGallery[activeMediaIdx].url]) ? (
              ...
              <div className="absolute inset-0 w-full h-full overflow-hidden">
                ...
                />
                {/* Clean, very feint Tedbuy Watermark Overlay */}
                <div className="absolute inset-0 pointer-events-none select-none flex items-center justify-center">
                  <div className="flex flex-col items-center justify-center text-center rotate-[-15deg] px-4 pointer-events-none select-none">
                    <span className="text-sm sm:text-base md:text-xl lg:text-2xl font-black text-white/15 tracking-[0.22em] font-sans uppercase drop-shadow-[0_1px_2px_rgba(0,0,0,0.25)] leading-tight">
                      POSTED ON TEDBUY
                    </span>
                    <span className="text-[10px] sm:text-xs md:text-sm font-extrabold text-white/15 tracking-[0.18em] font-sans uppercase drop-shadow-[0_1px_2px_rgba(0,0,0,0.25)] mt-0.5 sm:mt-1 max-w-[260px] md:max-w-sm truncate">
                      {watermarkSellerName}
                    </span>
                  </div>
                </div>
            ...
            >
              {(mediaGallery[lightboxIndex]?.type === 'video' && !videoErrors[mediaGallery[lightboxIndex].url]) ? (
                ...
                <div className="relative max-w-full max-h-[70vh] flex items-center justify-center select-none group/lightbox-img">
                  ...
                  />
                  {/* Clean, very feint Tedbuy Watermark Overlay in the middle of expanded image */}
                  <div className="absolute inset-0 pointer-events-none select-none flex items-center justify-center">
                    <div className="flex flex-col items-center justify-center text-center rotate-[-16deg] px-6 pointer-events-none select-none">
                      <span className="text-2xl sm:text-4xl md:text-5xl lg:text-6xl font-black text-white/15 tracking-[0.25em] font-sans uppercase drop-shadow-[0_2px_6px_rgba(0,0,0,0.35)] leading-tight">
                        POSTED ON TEDBUY
                      </span>
                      <span className="text-sm sm:text-xl md:text-2xl lg:text-3xl font-extrabold text-white/15 tracking-[0.2em] font-sans uppercase drop-shadow-[0_2px_6px_rgba(0,0,0,0.35)] mt-1.5 sm:mt-2.5 max-w-xl truncate">
                        {watermarkSellerName}
                      </span>
                    </div>
                  </div>
