...
import { isUserVerified, isUserAdmin, isReservedStoreName } from '../types';
      ...
      {settingsTab === 'profile' ? (
        ...
        <div className="space-y-6">
          <div className="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-3xs flex flex-col items-center text-center animate-fade-in">
            ...
            <p className="text-[10px] text-slate-400 font-medium mt-1">{formatTedbuyTenure(currentUser.joinDate)}</p>
