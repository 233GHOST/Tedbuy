          ...
          <div className="bg-white border border-slate-200/90 rounded-2xl p-6 shadow-3xs flex flex-col items-center text-center animate-fade-in">
            ...
            <div className="mt-5 space-y-2">
              <button
                ...
                className="w-full px-4.5 py-3 bg-slate-50 hover:bg-rose-50 hover:text-rose-700 text-slate-700 font-bold rounded-2xl text-xs transition duration-150 border border-slate-200 hover:border-rose-150 flex items-center justify-center gap-2 cursor-pointer shadow-3xs"
              >
          ...
          <div className="bg-rose-50/25 border border-rose-150 rounded-3xl p-6 sm:p-8 mt-8 space-y-4">
            ...
            <div className="space-y-1">
              ...
              <p className="text-[11px] text-slate-500 leading-relaxed">
                Deleting your account deletes your registered email/phone identification, profile metadata, and saved favorites history from our backend storage instantly. This action is irreversible.
              </p>
            </div>
