...
export interface CustomIntersectionObserverInit extends IntersectionObserverInit {
  initialIsVisible?: boolean;
}

export function useIntersectionObserver(options: CustomIntersectionObserverInit = {}) {
  const [isIntersecting, setIsIntersecting] = useState<boolean>(!!options.initialIsVisible);
