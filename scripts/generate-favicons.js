...
function allOutputFilesExist(publicDir) {
  return REQUIRED_FAVICON_FILES.every((file) => fs.existsSync(path.join(publicDir, file)));
}
...
async function generate() {
  try {
    ...
    if (allOutputFilesExist(publicDir)) {
      console.log('[Favicon Generator] Skipping generation; favicon files already exist.');
      return;
    }
